...
- [Процесс авторизации](#процесс-авторизации)
	...
	- [API авторизации с через VK](#api-авторизации-с-через-vk)
	- [API авторизации с через Facebook](#api-авторизации-с-через-facebook)
...
## API авторизации с через VK:

*Будет реализовано в будущем.*

## API авторизации с через Facebook:
...
### Редактирование события from organizator
